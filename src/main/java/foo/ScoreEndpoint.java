...
public class ScoreEndpoint {
	...
	public List<Entity> scores(User user) throws UnauthorizedException {
		if (user == null) {
			throw new UnauthorizedException("Invalid credentials");
		}
	...
	@ApiMethod(name = "mytopscores", httpMethod = HttpMethod.GET)
	public List<Entity> mytopscores(@Named("name") String name) {
	...
	public Entity addScore(User user, @Named("score") int score, @Named("name") String name)
